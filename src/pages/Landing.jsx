    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-brand-900 to-slate-900">
      ...
      <section className="px-6 lg:px-16 py-24 text-center max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link to="/login" className="flex items-center gap-2 px-6 py-3 bg-brand-500 hover:bg-brand-400 text-white font-semibold rounded-xl transition-colors">
      ...
      <section className="px-6 lg:px-16 py-16 text-center">
        <div className="max-w-2xl mx-auto bg-white/5 border border-white/10 rounded-2xl p-10">
          ...
          <Link to="/login" className="inline-flex items-center gap-2 px-6 py-3 bg-brand-500 hover:bg-brand-400 text-white font-semibold rounded-xl transition-colors">
